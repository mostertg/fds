...
_index_ consumes a natural number $i$ and a sequence $s_0,s_1,…s_{k−1}$ (where $i \lt k$), and produces the element $s_i$.
...
**remove**: one parameter, a sequence $S=s_0,s_1,\dots,s_k$; precondition $length \ S \gt 0$; no value produced; postcondition is that $S$ has value $s_1,\dots,s_k$.
